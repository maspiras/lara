...
<script src="https://getbootstrap.com/docs/5.3/assets/js/color-modes.js"></script>
  ...
  <meta name="author" content="TripComfy Travel and Tours">  
  ...
  @stack('styles')
    ...
    <link href="https://getbootstrap.com/docs/5.3/examples/pricing/pricing.css" rel="stylesheet">
  </head>
  <body>
...
<div class="container py-3">
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      ...
      <img class="mb-2" src="images/logo.png" alt="" width="40" height="40" class="me-2">        
      </a>
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        @auth
        <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="{{ url('/') }}/dashboard">Dashboard</a>
        @else
        <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="{{ url('/') }}/login">Login</a>
        <a class="py-2 link-body-emphasis text-decoration-none" href="{{ url('/') }}/register">Register</a>
        @endauth
      </nav>
    </div>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      ...
      <p class="fs-5 text-body-secondary">Quickly build an effective pricing table for your potential customers with gbook app. It’s built with default Booking components and utilities with little customization.</p>
    </div>
  </header>
  ...
  <footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
      <div class="col-12 col-md">
        <img class="mb-2" src="images/logo.jpg" alt="" width="24" height="24">
