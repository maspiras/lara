        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <small class="text-body-secondary">Casita 1, Casita 2, Casita 3, Casita 4</small>
            </div>
            <span class="text-body-secondary">60,000</span>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">Cooking</h6>
              <small class="text-body-secondary">Your kitchen bill</small>
            </div>
            <span class="text-body-secondary">500</span>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">Parking</h6>
